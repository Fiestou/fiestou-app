...
const Card: React.FC<CardProps> = (props) => {
  ...
  const [elementsRelatedDetails, setElementsRelatedDetail] = useState<
    categorie[]
  >([]);
          ...
          prev.map((el) =>
            el.id === data.id
              ? {
                  ...
                  name: data.name,
                  icon: data.icon,
                  element_related_id: data.element_related_id,
                }
              : el
          )
        );
      ...
      {isTooltipVisible && (
        ...
        >
          ...
          >
            ...
            <label className="flex-2 w-full flex justify-start items-start cursor-pointer">
              Editar
            </label>
          </button>
          {!props.grouptargeadc && (
            ...
            >
              ...
              <label className="flex-2 w-full flex justify-center items-center cursor-pointer">
                Excluir
              </label>
            </button>
          )}
