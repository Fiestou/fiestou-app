    ...
    >
      ...
      {form.loading && (
        <div className="fixed inset-0 bg-white flex justify-center items-center">
          <div className="flex flex-col items-center justify-center gap-3 px-6 py-4 bg-white border border-zinc-200 rounded-lg shadow-lg max-w-sm mx-auto">
            <div className="flex items-center gap-2 text-zinc-700 text-base font-semibold">
            ...
            <div className="text-4xl">
              {subimitStatus === "register_complete" ? (
                ...
                <Icon icon="fa-spinner-third" className="text-yellow-500 animate-spin" />
              )}
            </div>
          </div>
        </div>
